...
// Implementing ability to find length of linked list - 7/11/2020
...
//Function to find length of linked list iteratively
/*
int findLength(struct Node* head)
{
    ...
    //Count the nodes in the linked list one by one
    while (current != NULL)
    {
        count++;
